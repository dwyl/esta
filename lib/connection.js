...
/**
 * checkInedex does two jobs: (a) test if the connection is valid
 * (b) create the index if it does not already exist (to avoid ugly errors!)
 * @param {String} index - the name of the index we want to check exists
