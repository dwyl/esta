...
//
// test(chalk.cyan('JUST SET unset keys (NO BACKUP required!)'), function (t) {
//   var record = require('./fake_record.js')(); // fresh fake record
//   record.message = "Oh, I just can't wait to be king!"
//   var bak = {}; // make a copy of record for later.
//   bak.index = record.index;
//   bak.type  = record.type + "_bak";
//
//   CREATE(record, function(res) {
//     console.log(chalk.pink(" > > > > CREATE res:"));
//     console.log(res);
//     record.new_field = 'Can you feel the love tonight?' ;
//
//     UPDATE(record, function(res2) {
//       // confirm the record was UPDATED (first time)
//       READ(record, function(response) {
